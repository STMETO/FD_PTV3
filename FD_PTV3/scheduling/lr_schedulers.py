...
class FedServerCosineAnnealingLR(FedServerLRScheduler):
    ...
    def state_dict(self):
        d = super().state_dict()
        d.update({'total_rounds': self.total_rounds, 'min_lr': self.min_lr})
        return d
...
class FedServerReduceLROnPlateau(FedServerLRScheduler):
    ...
    def state_dict(self):
        ...
        d.update({
            ...
            'best_metric': self.best_metric, 'wait_count': self.wait_count,
        })
        return d
...
class FedServerGradientNormAdaptiveLR(FedServerLRScheduler):
    ...
    def state_dict(self):
        d = super().state_dict()
        d.update({'target_norm': self.target_norm, 'min_lr': self.min_lr, 'max_lr': self.max_lr})
        return d
...
class FedServerLinearWarmupLR(FedServerLRScheduler):
    ...
    def state_dict(self):
        d = super().state_dict()
        d.update({'warmup_rounds': self.warmup_rounds, 'warmup_start_lr': self.warmup_start_lr,
                   'max_lr': self.max_lr, 'final_lr': self.final_lr})
        return d
...
class FedServerLinearDecayLR(FedServerLRScheduler):
    ...
    def state_dict(self):
        d = super().state_dict()
        d.update({'decay_rounds': self.decay_rounds, 'decay_start_lr': self.decay_start_lr,
                   'min_lr': self.min_lr, 'final_lr': self.final_lr})
        return d
