"""Shared runtime defaults for the minimal federated project.

The standard S3DIS config inherits from this file. Keep generic training and
testing behavior here so task-specific configs only override what they really
change.
"""
...
hooks = [
    ...
    dict(type="SemSegEvaluator", write_cls_iou=True, write_cls_acc=True),
