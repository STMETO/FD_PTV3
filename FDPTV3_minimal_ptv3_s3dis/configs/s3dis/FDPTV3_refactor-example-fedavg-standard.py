"""Standard PTv3 + S3DIS federated training config used by the minimal project.

This file is the single recommended entry config for the extracted codebase.
If you want to start from a known-good baseline, duplicate this file first and
...
federated = dict(
    ...
    total_rounds=100,
    users_per_gpu=1,
    msg="FDPTV3_refactor-Example-FedAvg-Standard",
