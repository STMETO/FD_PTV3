"""Strategy factory for the minimal federated project.

Only the standard Flower strategies needed by the extracted baseline are wired
here. The selector centralizes how server-side schedulers and aggregation logic
are paired with the chosen federated algorithm.
"""
...
def build_strategy(
    ...
    # Hyperparameters are grouped by aggregation method in the config. This
    # helper resolves the active method and extracts just the relevant section.
    fed_cfg = _get_cfg(cfg, "federated", {})
