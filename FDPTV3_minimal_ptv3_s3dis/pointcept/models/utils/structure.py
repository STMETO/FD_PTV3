"""Core Point data structure used across the minimal PTv3 pipeline.

The Point wrapper is the common payload format exchanged between dataset
collation, sparse preparation, serialization and the PTv3 backbone.
"""
...
class Point(Dict):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Keep offset and batch in sync so downstream modules can rely on either
    ...
    def serialization(self, order="z", depth=None, shuffle_orders=False):
        ...
        # Build one serialization code per requested space-filling order. The
        # resulting order/inverse tensors let the backbone switch layouts while
        # still being able to restore original point ordering later.
        # [Order1 ([n]),
        #  Order2 ([n]),
        #   ...
        #  OrderN ([n])] (k, n)
