...
def get_root_logger(log_file=None, log_level=logging.INFO, file_mode="a",name="pointcept"):
    """Get the root logger.
    ...
    """
    logger = get_logger(
        name=name, log_file=log_file, log_level=log_level, file_mode=file_mode
    )
    return logger
