"""Generic dataset scaffolding used by the minimal S3DIS pipeline.

S3DIS itself is only a thin subclass in this project. Most of the actual data
loading behavior lives here: listing sample folders, reading npy assets,
running transforms and assembling train/test dictionaries.
"""
...
class DefaultDataset(Dataset):
    ...
    def get_data(self, idx):
        # Each sample is stored as a directory containing multiple npy assets.
        # We load only the known semantic-segmentation assets retained by the
        # minimal project.
    ...
    def prepare_train_data(self, idx):
        # Training path: raw sample -> transform pipeline -> collatable dict.
