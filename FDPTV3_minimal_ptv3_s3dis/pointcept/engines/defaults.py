"""Default CLI/runtime helpers used by the minimal PTv3 federated project.

This module is shared by training and testing entrypoints. In the extracted
codebase it remains important because it owns command-line parsing, config file
loading, worker/batch normalization and random-seed setup.
"""
...
def create_ddp_model(model, *, fp16_compression=False, **kwargs):
    ...
    The minimal federated project still reuses the upstream DDP construction
    path so that centralized Pointcept training and federated local training use
