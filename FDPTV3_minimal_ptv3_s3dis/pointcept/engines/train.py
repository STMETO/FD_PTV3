...
class MultiDatasetTrainer(Trainer):
    def build_train_loader(self):
        raise NotImplementedError(
            "MultiDatasetTrainer is intentionally excluded from the minimal "
            "PTv3 + S3DIS extraction. Add pointcept.datasets.MultiDatasetDataloader "
            "back before enabling multi-dataset configs."
        )
